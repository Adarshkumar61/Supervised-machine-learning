...
# # how important a word is to
# vectorizer = TfidfVectorizer()
# # .fit_transform will learn the vocabulary and idf from training set, 
...
main_col = ['genres', 'keywords', 'tagline', 'cast', 'director']
for col in main_col:
...
user_inp = input('Enter the movie name: ')
title = difflib.get_close_matches(user_inp, data['title'])
